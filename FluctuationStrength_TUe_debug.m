function [fluct,fi,outs] = FluctuationStrength_TUe_debug(insig_b, fs, N)
% function [fluct,fi,outs] = FluctuationStrength_TUe_debug(insig_b, fs, N)
%
% 1. Description:
...
for iFrame = 1:nFrames
    ...
    [mdept,hBPi,outs_mdepth] = il_modulation_depths(ei,model_par.Hweight);
...
outs.t     = t; % time stamp
outs.z     = transpose(z);
outs.h0    = outs_mdepth.h0;
outs.hBPrms= outs_mdepth.hBPrms;

disp('')
%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [mdept,hBPi,outs] = il_modulation_depths(ei,Hweight)
